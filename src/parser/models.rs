...
impl From<KnownEntry> for TranscriptEntry {
    fn from(entry: KnownEntry) -> Self {
        match entry {
            ...
            KnownEntry::AiTitle(e) => TranscriptEntry::AiTitle(e),
        }
    }
}
...
/// Session title generated by Claude Code (written when a session is titled).
#[derive(Debug, Deserialize)]
...
impl TranscriptEntry {
    pub fn common(&self) -> Option<&CommonFields> {
        match self {
            ...
            TranscriptEntry::AiTitle(e) => Some(&e.common),
    ...
    pub fn type_name(&self) -> &str {
        match self {
            ...
            TranscriptEntry::AiTitle(_) => "ai-title",
